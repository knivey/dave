...
func TestLoadConfigDefaults(t *testing.T) {
	for _, key := range []string{
		...
		"FETCH_MAX_BODY_SIZE", "FETCH_PROXY_URL", "FETCH_CACHE_DSN",
		"FETCH_CACHE_MARKDOWN_TTL", "FETCH_READABILITY_DISABLED",
	} {
		os.Unsetenv(key)
	}
	...
	assert.Equal(t, int64(20*1024*1024), cfg.Fetch.MaxBodySize)
...
func TestLoadConfigFromEnv(t *testing.T) {
	...
	t.Setenv("FETCH_MAX_BODY_SIZE", "5242880")
	...
	assert.Equal(t, int64(5242880), cfg.Fetch.MaxBodySize)
